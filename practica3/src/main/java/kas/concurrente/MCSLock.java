...
public class MCSLock implements Lock {
    ...
    public void unlock() {
        ...
        QNode qnode = myNode.get();
        if (qnode.next == null) {
            System.out.println(Thread.currentThread().getName() + " - No hay sucesor. Intentando liberar tail...");
            if (tail.compareAndSet(qnode, null)) {
                System.out.println(Thread.currentThread().getName() + " - Bloqueo liberado sin sucesores.");
                return;
            }
